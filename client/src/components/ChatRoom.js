    ...
    return(<div className='chat-room' style={{float: 'left', maxWidth: '80%'}}>
            ...
            }
            {
              ...
              : <div className="avatar">
                  <img src={`https://graph.facebook.com/${UserData.id}/picture?type=square`} alt='fbp' draggable="false"/>
                  <img src={`https://graph.facebook.com/${pm_userdata.id}/picture?type=square`} alt='fbp' draggable="false"/>
                </div>
            }
            <ol className="chat">
              {
